	...
	<div class="row">
		...
		<div class="col-lg-8">
				...
				<div class="card-body d-flex blog_flex">
					<div class="flex-part1">
						<a href="single_post.php?id=<?=$result['blog_id']?>">
						    <?php $img = $result['bolg_image'] ?>
						    <img src="admin/uploade/<?= $img ?>"> </a>
					</div>
					<div class="flex-grow-1 flex-part2">
						...
						<p>
						  ...
						  <?= strip_tags(substr($result['blog_body'],0,300.))."..."?>
						  </a> <span><br>
						...
						<ul>
							...
							<li>
								<a href="category.php?id=<?= $result['cat_id'] ?>" class="text-primary"> <span><i class="fa fa-tag" aria-hidden="true"></i></span> <?= $result['cate_name']?> </a>
						    </li>
						</ul>
					</div>
				</div>
			...
			<ul class = "pagination pt-2 pb-5 ">
			    ...
			    <li class="page-item mt-2 <?=($i == $page)? $active = 'active' : ''; ?>">
